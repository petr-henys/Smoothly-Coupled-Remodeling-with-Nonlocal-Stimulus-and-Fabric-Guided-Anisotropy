...
\rev{%
\paragraph{Comparison with inter-subject variability.}
Using linear interpolation of the discrete sweep metrics, the interpolated baseline at $\Delta\alpha_{\mathrm{front}}=0^\circ$ is $\mathrm{RMSE}=0.575$~g/cm$^3$ and $\mathrm{corr}=0.627$.
Over a physiologic frontal-angle uncertainty band of $\pm 7^\circ$, the total RMSE varies only from 0.572 to 0.578~g/cm$^3$ (spread 0.006~g/cm$^3$) and the Pearson correlation from 0.611 to 0.643 (spread 0.032).
Over the more permissive $\pm 13^\circ$ band, the RMSE range is 0.563--0.581~g/cm$^3$ (spread 0.018~g/cm$^3$) and the correlation range is 0.602--0.654 (spread 0.052).
These shifts remain small relative to the HFValid inter-subject density variability band ($\pm 2\sigma$), which reaches 0.3--0.8~g/cm$^3$ depending on compartment and axial position, and they are also markedly smaller than the full $40^\circ$ sweep spread in RMSE (0.050~g/cm$^3$).
Accordingly, load-direction uncertainty is quantitatively relevant but not dominant when compared with the population-level scatter of the mapped CT reference. 
}
