#!/usr/bin/env python3
"""
Tests for analysis I/O utilities (NPZ save/load).

Tests:
- NPZ save/load roundtrip for scalar, vector, and tensor fields.
- Coordinate-based matching for MPI-independence.
- Element mismatch detection.
"""
...
from analysis.analysis_utils import save_function_npz, load_npz_field

@pytest.mark.mpi
def test_npz_roundtrip_scalar_vector_tensor(shared_tmpdir):
    """Verify NPZ save/load with coordinate-based matching.
