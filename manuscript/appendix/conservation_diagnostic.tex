...
\begin{figure}[htbp]
    ...
    \caption{Conservation diagnostic for the physiological benchmark case (\texttt{box\_physio}).
...
\begin{figure}[htbp]
    ...
    \caption{Conservation diagnostic for the stiffened benchmark case (\texttt{box\_stiff}).
