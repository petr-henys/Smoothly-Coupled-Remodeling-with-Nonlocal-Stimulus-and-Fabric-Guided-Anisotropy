...
\rev{The interpretation of this ratio is also inseparable from how the cortical shell is represented in the image-based model: CT-based FE studies of the proximal femur show that improved cortical mapping materially affects strain prediction in the thin shell \cite{Falcinelli2020_CorticalAssignment}.}
