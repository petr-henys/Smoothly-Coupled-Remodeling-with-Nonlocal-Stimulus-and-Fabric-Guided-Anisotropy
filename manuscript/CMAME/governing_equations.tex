...
\rev{The law is used here as an apparent-level constitutive closure: unlike bottom-up osteon-scale elasto-damage models \cite{Gizzi2022_OsteonMechanics}, it does not resolve explicit microstructural damage mechanisms, but instead encodes anisotropy through the evolving fabric field.}
