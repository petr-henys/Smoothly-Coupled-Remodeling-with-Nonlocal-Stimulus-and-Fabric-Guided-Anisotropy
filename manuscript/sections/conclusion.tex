...
The femur case study serves as a robustness demonstration on anatomical geometry referenced to a population-template CT field: compartment-aware reference stimuli improve similarity to that reference under a small set of representative daily loads, while sensitivity analyses show that plausible uncertainty in hip-force direction can materially alter both spatial redistribution and global density trajectories.
