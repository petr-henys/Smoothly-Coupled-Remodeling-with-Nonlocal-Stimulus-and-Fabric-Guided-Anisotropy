...
\begin{figure}[htbp]
  \centering
  \IfFileExists{images/diffusion_effect.png}{%
    \includegraphics[width=0.5\linewidth]{images/diffusion_effect.png}%
  }{\fbox{\parbox{1\linewidth}{\centering Missing image: \texttt{images/diffusion_effect.png}}}}
  \caption{}
