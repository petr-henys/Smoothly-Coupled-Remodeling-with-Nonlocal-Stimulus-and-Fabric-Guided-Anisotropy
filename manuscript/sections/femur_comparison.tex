...
In addition, we track the global density evolution via the domain-mean density $\bar\rho(t)$ reconstructed from the conserved mass integral (logged as \texttt{total\_mass\_g} in \texttt{steps.csv}), which provides a coarse check of transient behavior and settling time.
