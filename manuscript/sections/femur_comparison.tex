...
\begin{figure}[htbp]
  ...
  \caption{Global density distributions at $T=500$ days for the CT template and selected ratios (default: $r=1$ and the best-RMSE run in this sweep, here $r=3$), illustrating how the ratio controls the overall density spectrum.
  Generated by \texttt{analysis/psi\_ref\_ratio\_analysis.py}.}
