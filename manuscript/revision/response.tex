...
\response
We apologise for the broken links. The review copy still pointed to private or unreleased records, so the public-facing URLs indeed did not resolve. We have therefore revised the Reproducibility section to avoid claiming active public access at this stage, and we will activate and re-check the GitHub and Zenodo links before the final accepted version is delivered.

\change
Reproducibility section rewritten to clarify that the public GitHub and Zenodo records will be activated and verified for the final accepted version.
